...
const UpdatePassword = () => {
    ...
    const [formData , setFormData] = useState({ CreateNewPassword : "" , ConfirmNewPassword : "" })
    ...
    const SubmitHandler = (event)=>{
        ...
        dispatch(forgotPassword( formData.CreateNewPassword , formData.ConfirmNewPassword , token , navigate))
  ...
  return (
    ...
    <p className=' text-richblack-300 font-inter text-[.8rem] '>Almost done. Enter your new password and youre all set.</p>
